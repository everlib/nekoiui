...
import { X, ChevronDownIcon, CheckIcon, XIcon, CircleIcon, ChevronRightIcon, ChevronUpIcon, Loader2Icon } from 'lucide-react';
...
function SelectTrigger({
  ...
  return /* @__PURE__ */ jsxs(
    SelectPrimitive.Trigger,
    {
      ...
      children: [
        children,
        /* @__PURE__ */ jsx(SelectPrimitive.Icon, { asChild: true, children: /* @__PURE__ */ jsx(ChevronDownIcon, { className: "size-4 opacity-40" }) })
      ]
    }
  );
}
...
function SelectItem({ className, children, ...props }) {
  return /* @__PURE__ */ jsxs(
    SelectPrimitive.Item,
    {
      ...
      ...props,
      children: [
        /* @__PURE__ */ jsx("span", { className: "absolute right-2 flex size-3.5 items-center justify-center", children: /* @__PURE__ */ jsx(SelectPrimitive.ItemIndicator, { children: /* @__PURE__ */ jsx(CheckIcon, { className: "size-3.5 text-primary" }) }) }),
